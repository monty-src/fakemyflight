...
const Form = ({ setFlights }) => {
  ...
  const whenInput =
    radio === 0 ? classNames('hidden') : classNames('opacity-100');
  const datePickerGrid =
    radio === 0 ? classNames('sm:grid-cols-1') : classNames('sm:grid-cols-2');
        ...
        <div className="md:flex md:items-center mb-5">
          <div className="flex-grow">
            <div className="flex cursor-pointer w-full">
              <button
                onClick={() => setRadio(0)}
                className={`border-[#10455a] ${
                  radio === 0 && `bg-[#10455a]`
                } py-3 px-3 text-white rounded-l-lg border-2 w-full transition-all`}
              >
                One-Way
              </button>
              <button
                ...
                className={`border-[#10455a] ${
                  radio === 1 && `bg-[#10455a]`
                } py-3 px-3 text-white rounded-r-lg border-t-2 border-b-2 border-r-2 w-full transition-all`}
              >
                Round Trip
              </button>
            </div>
          ...
          <div className="flex-grow invisible md:block hidden">
            <div className="flex cursor-pointer w-full">
              <button
                ...
                className={`border-[#10455a] ${
                  radio === 1 && `bg-[#10455a]`
                } py-3 px-4 text-white rounded-l-lg border-2 w-full transition-all`}
              >
                One-Way
              </button>
              <button
                ...
                className={`border-[#10455a] ${
                  radio === 1 && `bg-[#10455a]`
                } py-3 px-4 bg-blue text-white rounded-r-lg border-t-2 border-b-2 border-r-2 w-full transition-all`}
              >
                Round Trip
              </button>
            </div>
