...
const MainForm = ({ radio, setRadio, setFlights }) => {
  ...
  return (
    <section className="grid grid-cols-6 gap-5">
      ...
      />
      <button
        className="mt-10 inline-flex items-center justify-center w-full px-3 py-3 text-white bg-[#10455a] rounded-lg sm:w-auto"
        onClick={onSubmit}
      >
        <svg
